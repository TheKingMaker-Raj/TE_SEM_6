    ...
    if (gender == "M")
    {
        if (domain == "web")
        {
            if (n2 >= 37 and n1 >= 7)
            {
                if (n3 <= 800000)
                {
                    cout << "Acccording to the performance of " << name << " the salary recommended to be incremented by 100000" << endl;
                }

                else
                {
                    cout << "Acccording to the performance of " << name << " the salary recommended to remain same" << endl;
                }
            }
            else
            {
                if (n3 >= 1500000)
                {
                    cout << "Acccording to the performance of " << name << " the salary recommended to be decremented by 100000" << endl;
                }
                else
                {
                    cout << "Acccording to the performance of " << name << " the salary recommended to remain same" << endl;
        ...
        if (n7 > 8 and n4 == 5)
        {
            cout << name << " recommended to get a promotion in the company" << endl;
        }
    }
    if (gender == "F")
    {
        ...
        else if (domain == " design")
        {
            if (n2 >= 32 and n1 > 6)
            {
                ...
                {
                    cout << "Acccording to the performance of " << name << " the salaray recommended to remain same" << endl;
                }
            }
        }
        if (rat > n4)
